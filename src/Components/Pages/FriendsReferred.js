  ...
  return (
    <div>
      <div className="flex justify-around">
        <div>
          <h1 className="text-neutral font-semibold subpixel-antialiased">
            Your Referral Code
          </h1>
          <p className="border border-purple-100 shadow-2xl hover:scale-105 duration-500 ease-in-out tracking-widest text-xl px-8 py-2 rounded-lg whitespace-pre">
            E D C H 5 4
          </p>
        </div>
        <div className="shadow-2xl p-5 rounded-2xl">
          <h3 className="text-neutral subpixel-antialiased">Wallet Balance</h3>
          <h3 className="font-semibold text-lg">₹ 500</h3>
        </div>
      </div>
      <div>
        <h1 className="text-2xl pl-10 mt-10 font-semibold text-neutral">
